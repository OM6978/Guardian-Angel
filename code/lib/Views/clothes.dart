...
class _MyClothesState extends State<MyClothes> {
  ...
  bool isOthersSelected_clothes = false;
  String? selectedOption_clothes;
  bool isOthersSelected_gender = false;
  String? selectedOption_gender;
  ...
  Widget buildTextField(String? selectedOption) {
    return TextField(
          ...
          child: Center(
            child: FutureBuilder<String>(
              future: _translateText(
                  selectedOption_gender ?? 'Select an option',
        ...
        PopupMenuButton<String>(
            ...
            return <PopupMenuEntry<String>>[
              for (String value in [
                ...
                PopupMenuItem<String>(
                  value: value,
                  child: FutureBuilder<String>(
                    future: _translateText(value, toLanguage: widget.language),
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
          ...
          onSelected: (String? value) {
            if (value != null) {
              setState(() {
                if (value == 'Others') {
                  isOthersSelected_clothes = true;
                } else {
                  selectedOption_clothes = value;
                }
              });
            }
          },
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                          ...
                          Positioned(
                            ...
                            child: SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: Center(
                                  child: Image.asset(
                                    'assets/images/clothes.png', // Replace with the path to your PNG file
                                    // fit: BoxFit.cover,
                                  ),
                                ),
                              ),
            ...
            Padding(
                padding: EdgeInsets.only(left: 161.0),
                child: FutureBuilder<String>(
            ...
            Padding(
                padding: EdgeInsets.only(left: 156.0),
                child: FutureBuilder<String>(
                  future: _translateText('Type of Clothing',
                      toLanguage: widget.language),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return Text(
            ...
            SizedBox(
              height: 71,
              child: Padding(
                padding: const EdgeInsets.only(left: 45.0), // Add left margin
                child: Stack(
                  children: [
                    Container(
                      width: 320,
                      ...
                      child: Column(
                        children: [
                          if (!isOthersSelected_clothes) buildDropdown(),
                        ],
                      ),
                    ),
                    if (isOthersSelected_clothes)
                      Positioned(
                        child: Container(
                          width: 320,
                          height: 50,
                          padding: const EdgeInsets.only(left: 16),
                          child: buildTextField(selectedOption_clothes),
                        ),
                      ),
                  ],
                ),
            ...
            Padding(
                padding: EdgeInsets.only(left: 171.0, top: 8.0),
                child: FutureBuilder<String>(
                  future: _translateText('Gender', toLanguage: widget.language),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return Text(
                        snapshot.data!,
                                ...
                                PopupMenuButton<String>(
                                  ...
                                  onSelected: (String? value) {
                                    if (value != null) {
                                      setState(() {
                                        if (value == 'Others') {
                                          isOthersSelected_gender = true;
                                        } else {
                                          selectedOption_gender = value;
                                        }
                                      });
                                    }
                                  },
                    ...
                    if (isOthersSelected_gender)
                      Positioned(
                        child: Container(
                          ...
                          height: 50,
                          padding: const EdgeInsets.only(left: 16),
                          child: buildTextField(selectedOption_gender),
                        ),
                      ),
                  ],
                ),
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                    onPressed: () async {
                      ...
                      try {
                        final uri = Uri.parse(
                            "http://192.168.33.248:6174/contribute_clothes");
                        print("OK");
                        String base64Image =
                        ...
                        Map<String, dynamic> request = {
                          ...
                          "type_of_clothing": selectedOption_clothes,
                          "gender": selectedOption_gender,
                          "phone": widget.phone,
                          "image": base64Image,
