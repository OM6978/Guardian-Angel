        ...
        Expanded(
          child: Center(
            child: FutureBuilder<String>(
              future: _translateText(selectedOption ?? 'Select an option',
        ...
        child: Column(
          ...
          children: [
                          ...
                          Positioned(
                            ...
                            child: SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: Center(
                                  child: Image.asset(
                                    'assets/food.png', // Replace with the path to your PNG file
                                    // fit: BoxFit.cover,
                                  ),
                                ),
                              ),
            ...
            Padding(
                ...
                child: FutureBuilder<String>(
                  future:
                      _translateText('Food Type', toLanguage: widget.language),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return Text(
                        snapshot.data!,
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          if (!isOthersSelected) buildDropdown(),
                        ],
                      ),
                    ),
                    if (isOthersSelected)
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                    onPressed: () async {
                      ...
                      try {
                        final uri = Uri.parse(
                            "http://192.168.33.248:6174/contribute_food");
                        print("OK");
                        String base64Image =
